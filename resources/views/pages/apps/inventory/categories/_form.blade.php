...
<div class="card border-0 shadow-sm">
    <div class="card-body">
        ...
        <div class="row g-5">
            <div class="col-md-6">
                ...
                <input type="number" min="0" name="sort_order" value="{{ old('sort_order', $category->sort_order ?? 0) }}" class="form-control form-control-solid">
            </div>
            <div class="col-md-6">
    ...
    <div class="card-footer d-flex justify-content-end gap-3">
        <a href="{{ route('inventory.categories.index') }}" class="btn btn-light">Cancel</a>

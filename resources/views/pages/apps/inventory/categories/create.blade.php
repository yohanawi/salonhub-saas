<x-default-layout>
    ...
    @endsection
    @section('breadcrumbs')
        {{ Breadcrumbs::render('inventory.categories.create') }}
    @endsection
        ...
        <div class="card border-0 shadow-sm overflow-hidden mb-5">
            <div class="card-body p-4 p-lg-6">
                <div class="d-flex align-items-center gap-5">
                    ...
                    <div>
                        <h3 class="fw-bolder text-gray-900 mb-1">Add Product Category</h3>
                        <div class="text-muted">Create a new category to organize your product catalog.</div>
                    </div>
                </div>
            </div>
        </div>

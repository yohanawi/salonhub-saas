                    ...
                    <div id="kt_security_recent_alerts" class="carousel carousel-custom carousel-stretch slide"
                        ...
                        <div class="d-flex flex-stack align-items-center flex-wrap">
                            ...
                            <ol class="p-0 m-0 carousel-indicators carousel-indicators-dots">
                                ...
                                <li data-bs-target="#kt_security_recent_alerts" data-bs-slide-to="1" class="ms-1">
                                </li>
                        ...
                        <div class="carousel-inner pt-6">
                            ...
                            <div class="carousel-item active">
                                ...
                                <div class="carousel-wrapper">
                                    ...
                                    <div class="d-flex flex-column flex-grow-1">
                                        <a href="#" class="fs-5 fw-bold text-gray-900 text-hover-primary">Latest
                                            Announcements</a>
                            ...
                            <div class="carousel-item">
                                ...
                                <div class="carousel-wrapper">
                                    <!--begin::Description-->
                                    <div class="d-flex flex-column flex-grow-1">
                                        <a href="#" class="fw-bold text-gray-900 text-hover-primary">Top Picks
                                            For You</a>
